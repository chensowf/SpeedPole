package com.txket.ss.tcpip;

public class UDPHeader {
    static final short offset_src_port = 0; // 源端口号
    static final short offset_dest_port = 2; // 目标端口号
    static final short offset_tlen = 4; // 数据包长度
    static final short offset_crc = 6; // 效验码
